...
https://olha36.github.io/diploma-ui/

Розробка має вестися на гілці develop, після чого мержитися в master і там має виконуватися команда deploy(описано нижче)
...
### Деплой з гілки master
`npm run deploy`

## Правила розробки
1) Розробка ведеться виключно на гілці `develop` зі створенням нових гілок і подальшого мерджу в `develop`
2) деплой виключно з гілки `master`
